...
class ProductDetailPage extends StatelessWidget {
        ...
        children: [
          ...
          Material(
            ...
            child: InkWell(
              ...
              child: Container(
                padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                child: const Icon(Icons.add, size: 18, color: Color(0xFF5B7FCD)),
              ),
            ),
          ),
        ],
            ...
            return Padding(
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  height: 48,
                  decoration: BoxDecoration(
                    color: isSelected ? const Color(0xFF5B7FCD) : Colors.white,
                    borderRadius: BorderRadius.circular(24),
                    border: Border.all(
                      color: isSelected ? const Color(0xFF5B7FCD) : const Color(0xFFE0E0E0),
                      width: 1.5,
                    ),
                  ),
                  child: Center(
  ...
  Widget _buildBottomNavigationBar(ProductDetailController controller) {
      ...
      child: SizedBox(
        ...
        child: Row(
          ...
          children: [
            ...
            _buildNavItem(Icons.search, 'Search', 1, controller),
            const SizedBox(width: 40),
            _buildNavItem(Icons.shopping_cart, 'Cart', 2, controller),
  ...
  Widget _buildNavItem(IconData icon, String label, int index, ProductDetailController controller) {
